...
export const services: Service[] = [
  ...
  },
  {
    ...
    title: "Development",
    description:
      "Frontend, backend, AI agents, and automation pipelines, built as one coherent system by one engineer who owns the whole picture. You get working software in review-able increments, not a big-bang reveal.",
